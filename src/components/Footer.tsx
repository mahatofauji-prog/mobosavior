          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 flex items-center gap-2.5">
              <a
                ...
                className="p-2 bg-slate-800 rounded-lg hover:bg-[#0284C7] hover:text-white text-slate-400 transition-colors"
              ...
              <a
                ...
                className="p-2 bg-slate-800 rounded-lg hover:bg-emerald-600 hover:text-white text-slate-400 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-emerald-950/70 border border-emerald-500/30 rounded-lg hover:bg-emerald-600 hover:text-white text-emerald-400 transition-colors"
              ...
              {contact.facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-slate-800 rounded-lg hover:bg-blue-600 hover:text-white text-slate-400 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-slate-800 rounded-lg hover:bg-pink-600 hover:text-white text-slate-400 transition-colors"
              ...
              <a
                ...
                className="p-2 bg-slate-800 rounded-lg hover:bg-sky-500 hover:text-white text-slate-400 transition-colors"
