...
export default function LocalBusinessSchema({ contact, service }: SchemaProps) {
  useEffect(() => {
    ...
    const schema = {
      ...
      'alternateName': 'MOBO SAVIOR Purulia Mobile Repair Lab',
      'description': 'Specialized mobile phone repair lab in Purulia, West Bengal. Expert micro-soldering, CPU reballing, iPhone screen replacement, and battery service by Saddam Bhai.',
