...
export const DEFAULT_FAQS: FAQItem[] = [
  {
    id: 'faq-1',
    question: 'Do you repair iPhones?',
    answer: 'Yes, we are iPhone repair experts in Purulia. We handle all iPhone models, from common display and battery replacements to complex logic board micro-soldering, Face ID repair, camera glass, and back glass replacements.',
    category: 'Services',
    displayOrder: 1
  },
  {
    ...
    answer: 'Absolutely. We repair all major Android brands, including Samsung, OnePlus, Xiaomi, Realme, Poco, Vivo, Oppo, Google Pixel, and Motorola. We specialize in both software issues and complex hardware repairs.',
    category: 'Services',
    displayOrder: 2
  },
  {
    id: 'faq-3',
    question: 'Do you replace mobile displays?',
    answer: 'Yes, we offer premium display screen replacements. We use top-quality OLED, AMOLED, and LCD panels. We transfer TrueTone and calibrate under-display sensors for a flawless original-feel performance.',
    category: 'Services',
    displayOrder: 3
  },
  {
    ...
    answer: 'Yes. We provide certified high-capacity battery replacements with safety circuits to resolve fast draining, overheating, and phone shutdowns.',
    category: 'Services',
    displayOrder: 4
  },
  {
    id: 'faq-5',
    question: 'Do you repair dead phones?',
    answer: 'Yes, we are highly specialized in diagnosing and reviving dead mobile phones. Whether it was water damaged, experienced a short circuit, or suddenly shut down, we have advanced tools like thermal cameras and diagnostic power supplies to find and fix the fault.',
    category: 'Services',
    displayOrder: 5
  },
  {
    id: 'faq-6',
    question: 'Do you repair charging issues?',
    answer: 'Yes, we clean dusty charging ports, replace charging sub-boards, repair damaged flex cables, or swap faulty charging ICs (like the Tristar chip on iPhones) to restore fast charging.',
    category: 'Services',
    displayOrder: 6
  },
  {
    id: 'faq-7',
    question: 'Do you provide CPU / IC level repair?',
    answer: 'Yes. We are one of the few labs in Purulia capable of CPU reballing, RAM upgrades, and direct IC-level micro-soldering. If your Poco X3, OnePlus, or Samsung is stuck on bootloop or dead due to CPU issues, we can reball it successfully.',
    category: 'Services',
    displayOrder: 7
  },
  {
    id: 'faq-8',
    question: 'Do you repair Flip and Fold phones?',
    answer: 'Yes, we carry out delicate repairs on foldable devices like Samsung Galaxy Z Fold & Z Flip series, including hinge restoration, screen film replacement, and flexible display module assembly.',
    category: 'Services',
    displayOrder: 8
  },
  {
    id: 'faq-9',
    question: 'Where is MOBO SAVIOR located?',
    answer: 'Our service center is located at Room No B4, Super Market, Hattola More, Purulia, West Bengal 723101, India. You can easily find us or get step-by-step directions using the Google Maps link on our contact page.',
    category: 'Location',
    displayOrder: 9
  },
  {
    ...
    answer: 'You can book a repair online in just 2 minutes! Use our multi-step booking tool on the website to select your service, enter your phone model, describe the issue, and choose your preferred date and time. You will get a unique booking ID to check your status instantly.',
    category: 'Booking',
    displayOrder: 10
  }
];
