...
export interface VideoItem {
  id: string;
  videoUrl: string; // youtube embed or firebase storage url
  thumbnailUrl?: string;
  title: string;
  description: string;
  category: string;
...
export type ReviewSource = 'google' | 'testimonial';
...
export type OfferCTAType = 'whatsapp' | 'service' | 'enquiry' | 'call';
